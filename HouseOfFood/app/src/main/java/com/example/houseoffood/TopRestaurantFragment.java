...
public class TopRestaurantFragment extends Fragment implements FoodAdapter.OnFoodItemClickListener{
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Query qFood = reference.child("foods").orderByChild("rate").startAt(4).limitToFirst(2);
