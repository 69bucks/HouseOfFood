...
public class TopFoodFragment extends Fragment implements FoodAdapter.OnFoodItemClickListener{
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        food = new Food();
        fvrtref = fDatabase.getReference("favorites");
        //fvrt_listRef = fDatabase.getReference("favoriteList").child();



        Query qFood = reference.child("foods").orderByChild("rate").startAt(4);
